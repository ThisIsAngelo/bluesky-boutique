              ...
              <div class=" mr-auto flex-column flex-lg-row align-items-center">
                <ul class="navbar-nav justify-content-between ">
                  ...
                  <div class=" d-none d-lg-flex">
                    ...
                    <a href="" class="ml-3 cartss"><i data-feather="search"></i></a>
                    <a href="{{url('show_cart')}}" class="cartss"><i data-feather="shopping-cart"></i></a>
                  </div>
                </ul>
              </div>
            </div>
      ...
      <div class="row">
        <div class="col-lg-3">
          <div class="detail_img-box">
            <img src="home/images/detail.png" alt="" class="w-100" />
          </div>
        </div>
        <div class=" col-lg-7">
          <div class="detail_container">
            <div class="detail-box d-box-1">
              <a href="">
                <div class="detail-content">
                  <img src="home/images/d-1.png" alt="" />
                  <h5>
                    Care kids
                  </h5>
                </div>
            ...
            <div class="detail-box d-box-2">
              <a href="">
                <div class="detail-content">
                  <img src="home/images/d-2.png" alt="" />
                  <h5>
                    Baby boy
                  </h5>
                </div>
            ...
            <div class="detail-box d-box-3">
              <a href="">
                <div class="detail-content">
                  <img src="home/images/d-3.png" alt="" />
                  <h5>
                    Baby girl
                  </h5>
                </div>
            ...
            <div class="detail-box d-box-4">
              <a href="">
                <div class="detail-content">
                  <img src="home/images/d-4.png" alt="" />
                  <h5>
                    Sale
                  </h5>
                </div>
          ...
          <div class="product_box">
            <div class="product_img-box">
              ...
              <div class="option_container">
                <a class="details" href="{{url('/product_details',$product->id)}}">Details</a>
                <div class="options">
      ...
      <div class="row">
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="find_container-img">
                  <img src="home/images/find-img.png" alt="" />
                </div>
              </div>
              <div class="col-sm-6">
                <h3>
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="shoe_img-box">
                  <img src="home/images/shoes.png" alt="" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-4">
          <div class="find_img-box">
            <img src="home/images/find-hero.png" alt="" />
          </div>
        </div>
      </div>
    </div>
                ...
                <div class="client_box">
                  <div class="client_id-box">
                    <div class="client_img-box">
                      <img src="home/images/client.png" alt="" />
                    </div>
                    <h4>Carlac liyo</h4>
                  </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-5">
            <div class="item_img-box">
              <img src="home/images/items.png" alt="" />
            </div>
          </div>
        </div>
      </div>
